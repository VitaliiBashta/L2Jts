...
import org.mmocore.gameserver.network.lineage.serverpackets.ShowCalc;
 ...
 */
public class action_calc extends ScriptItemHandler
{
	...
	public action_calc()
	{
		...
		for(final ItemTemplate template : ItemTemplateHolder.getInstance().getAllTemplates())
		{
			...
			if(template.getActionType() == ItemAction.action_calc)
			{
