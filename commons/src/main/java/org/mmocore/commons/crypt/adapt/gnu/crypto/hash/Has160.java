...
public class Has160 extends BaseHash {
    ...
    private static final int[] ndx = {
            18, 0, 1, 2, 3, 19, 4, 5, 6, 7, 16, 8, 9, 10, 11, 17, 12, 13, 14, 15, 18, 3, 6, 9, 12, 19, 15, 2, 5, 8, 16, 11, 14,
            1, 4, 17, 7, 10, 13, 0, 18, 12, 5, 14, 7, 19, 0, 9, 2, 11, 16, 4, 13, 6, 15, 17, 8, 1, 10, 3, 18, 7, 2, 13, 8, 19, 3,
            14, 9, 4, 16, 15, 10, 5, 0, 17, 11, 6, 1, 12
    };
    /**
     ...
     */
    private Has160(final Has160 md) {
        this();
    ...
    private static synchronized int[] has(final int hh0, final int hh1, final int hh2, final int hh3, final int hh4, final byte[] in, int offset) {
        int A = hh0;
        int B = hh1;
        int C = hh2;
        int D = hh3;
    ...
    protected void transform(final byte[] in, final int offset) {
        final int[] result = has(h0, h1, h2, h3, h4, in, offset);
    ...
    protected byte[] getResult() {
        return new byte[]{
                (byte) h0, (byte) (h0 >>> 8), (byte) (h0 >>> 16), (byte) (h0 >>> 24), (byte) h1, (byte) (h1 >>> 8),
                (byte) (h1 >>> 16), (byte) (h1 >>> 24), (byte) h2, (byte) (h2 >>> 8), (byte) (h2 >>> 16), (byte) (h2 >>> 24),
                (byte) h3, (byte) (h3 >>> 8), (byte) (h3 >>> 16), (byte) (h3 >>> 24), (byte) h4, (byte) (h4 >>> 8),
