package org.jts.dataparser.data.holder.itemdata;
...
import org.jts.dataparser.data.holder.itemdata.item.ec_cond.DefaultEquipCond;
import org.jts.dataparser.data.holder.itemdata.item.use_cond.DefaultUseCond;
import org.mmocore.commons.lang.ArrayUtils;

import static org.jts.dataparser.data.holder.ItemDataHolder.UseCondObjectFactory;
...
public class ItemData {
    ...
    @ObjectArray(canBeNull = true, objectFactory = UseCondObjectFactory.class)
    public DefaultUseCond[] use_condition = new DefaultUseCond[0];
    @ObjectArray(canBeNull = true, objectFactory = ItemDataHolder.EquipCondObjectFactory.class)
    ...
    public static enum ItemEquipOption {
        no_attack,
        only_use_weapon_skill,
        force_equip
    }

    public static enum DefendAttribute {
        none,
        fire,
        water,
        wind,
    ...
    public static enum ItemSlotBitType {
        none(0x00000),
        underwear(0x00001),
        rear(0x00002),
        lear(0x00004),
