package org.jts.dataparser.data.holder.npcdata;
...
import static org.jts.dataparser.data.holder.NpcDataHolder.NpcAIObjectFactory;
...
public class NpcData {
    ...
    @EnumValue
    public ItemData.WeaponType base_attack_type; // Всегда имеет значние, (Not
    // null)
    @IntValue
    ...
    @ObjectValue
    public ItemData.AttackAttribute base_attribute_attack; // Всегда имеет
    // како-либо
    // значение (Not
    // null)
    @IntArray
    public int[] base_attribute_defend; // Аттрибуты защиты, поле всегда имеет
    // какое-либо значение (Not null)
    @IntValue
