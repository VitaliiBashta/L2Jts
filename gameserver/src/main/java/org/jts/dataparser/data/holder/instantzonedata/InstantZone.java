...
import static org.jts.dataparser.data.holder.InstantZoneDataHolder.EntranceCondObjectFactory;
...
public class InstantZone {
    ...
    public static enum StartPosType {
        designatory,
        random
    }

    public static enum EndPosType {
        origin,
        nomination
    }
