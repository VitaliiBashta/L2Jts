...
import org.jts.dataparser.data.holder.pcparameter.ClassDataInfo;
import org.jts.dataparser.data.holder.pcparameter.base_parameter.BaseParameterArray;
import org.jts.dataparser.data.holder.pcparameter.base_parameter.BaseParameterInt;
import org.jts.dataparser.data.holder.pcparameter.bonus.LevelBonus;
import org.jts.dataparser.data.holder.pcparameter.bonus.ParameterBonus;
...
public class PCParameterHolder extends AbstractHolder {
    ...
    public void afterParsing() {
        super.afterParsing();
        conBonus.onInitCache();
        dexBonus.onInitCache();
        intBonus.onInitCache();
        menBonus.onInitCache();
        strBonus.onInitCache();
        witBonus.onInitCache();
        classDataInfo.put(ClassID.fighter.getClassId(), new ClassDataInfo(this.fighterHpTable, this.fighterMpTable, this.fighterCpTable));
        classDataInfo.put(ClassID.warrior.getClassId(), new ClassDataInfo(this.warriorHpTable, this.warriorMpTable, this.warriorCpTable));
        classDataInfo.put(ClassID.knight.getClassId(), new ClassDataInfo(this.knightHpTable, this.knightMpTable, this.knightCpTable));
        classDataInfo.put(ClassID.rogue.getClassId(), new ClassDataInfo(this.rogueHpTable, this.rogueMpTable, this.rogueCpTable));
        classDataInfo.put(ClassID.warlord.getClassId(), new ClassDataInfo(this.warlordHpTable, this.warlordMpTable, this.warlordCpTable));
        classDataInfo.put(ClassID.gladiator.getClassId(), new ClassDataInfo(this.gladiatorHpTable, this.gladiatorMpTable, this.gladiatorCpTable));
        classDataInfo.put(ClassID.paladin.getClassId(), new ClassDataInfo(this.paladinHpTable, this.paladinMpTable, this.paladinCpTable));
        classDataInfo.put(ClassID.dark_avenger.getClassId(), new ClassDataInfo(this.darkAvengerHpTable, this.darkAvengerMpTable, this.darkAvengerCpTable));
        classDataInfo.put(ClassID.treasure_hunter.getClassId(), new ClassDataInfo(this.treasureHunterHpTable, this.treasureHunterMpTable, this.treasureHunterCpTable));
        classDataInfo.put(ClassID.hawkeye.getClassId(), new ClassDataInfo(this.hawkeyeHpTable, this.hawkeyeMpTable, this.hawkeyeCpTable));
        classDataInfo.put(ClassID.mage.getClassId(), new ClassDataInfo(this.mageHpTable, this.mageMpTable, this.mageCpTable));
        classDataInfo.put(ClassID.wizard.getClassId(), new ClassDataInfo(this.wizardHpTable, this.wizardMpTable, this.wizardCpTable));
        classDataInfo.put(ClassID.cleric.getClassId(), new ClassDataInfo(this.clericHpTable, this.clericMpTable, this.clericCpTable));
        classDataInfo.put(ClassID.sorceror.getClassId(), new ClassDataInfo(this.sorcererHpTable, this.sorcererMpTable, this.sorcererCpTable));
        classDataInfo.put(ClassID.necromancer.getClassId(), new ClassDataInfo(this.necromancerHpTable, this.necromancerMpTable, this.necromancerCpTable));
        classDataInfo.put(ClassID.warlock.getClassId(), new ClassDataInfo(this.warlockHpTable, this.warlockMpTable, this.warlockCpTable));
        classDataInfo.put(ClassID.bishop.getClassId(), new ClassDataInfo(this.bishopHpTable, this.bishopMpTable, this.bishopCpTable));
        classDataInfo.put(ClassID.prophet.getClassId(), new ClassDataInfo(this.prophetHpTable, this.prophetMpTable, this.prophetCpTable));
        classDataInfo.put(ClassID.elven_fighter.getClassId(), new ClassDataInfo(this.elvenFighterHpTable, this.elvenFighterMpTable, this.elvenFighterCpTable));
        classDataInfo.put(ClassID.elven_knight.getClassId(), new ClassDataInfo(this.elvenKnightHpTable, this.elvenKnightMpTable, this.elvenKnightCpTable));
        classDataInfo.put(ClassID.elven_scout.getClassId(), new ClassDataInfo(this.elvenScoutHpTable, this.elvenScoutMpTable, this.elvenScoutCpTable));
        classDataInfo.put(ClassID.temple_knight.getClassId(), new ClassDataInfo(this.templeKnightHpTable, this.templeKnightMpTable, this.templeKnightCpTable));
        classDataInfo.put(ClassID.sword_singer.getClassId(), new ClassDataInfo(this.swordsingerHpTable, this.swordsingerMpTable, this.swordsingerCpTable));
        classDataInfo.put(ClassID.plains_walker.getClassId(), new ClassDataInfo(this.plainWalkerHpTable, this.plainWalkerMpTable, this.plainWalkerCpTable));
        classDataInfo.put(ClassID.silver_ranger.getClassId(), new ClassDataInfo(this.silverRangerHpTable, this.silverRangerMpTable, this.silverRangerCpTable));
        classDataInfo.put(ClassID.elven_mage.getClassId(), new ClassDataInfo(this.elvenMageHpTable, this.elvenMageMpTable, this.elvenMageCpTable));
        classDataInfo.put(ClassID.elven_wizard.getClassId(), new ClassDataInfo(this.elvenWizardHpTable, this.elvenWizardMpTable, this.elvenWizardCpTable));
        classDataInfo.put(ClassID.oracle.getClassId(), new ClassDataInfo(this.oracleHpTable, this.oracleMpTable, this.oracleCpTable));
        classDataInfo.put(ClassID.spellsinger.getClassId(), new ClassDataInfo(this.spellsingerHpTable, this.spellsingerMpTable, this.spellsingerCpTable));
        classDataInfo.put(ClassID.elemental_summoner.getClassId(), new ClassDataInfo(this.elementalSummonerHpTable, this.elementalSummonerMpTable, this.elementalSummonerCpTable));
        classDataInfo.put(ClassID.elder.getClassId(), new ClassDataInfo(this.elderHpTable, this.elderMpTable, this.elderCpTable));
        classDataInfo.put(ClassID.dark_fighter.getClassId(), new ClassDataInfo(this.darkFighterHpTable, this.darkFighterMpTable, this.darkFighterCpTable));
        classDataInfo.put(ClassID.palus_knight.getClassId(), new ClassDataInfo(this.palusKnightHpTable, this.palusKnightMpTable, this.palusKnightCpTable));
        classDataInfo.put(ClassID.assassin.getClassId(), new ClassDataInfo(this.assasinHpTable, this.assasinMpTable, this.assasinCpTable));
        classDataInfo.put(ClassID.shillien_knight.getClassId(), new ClassDataInfo(this.shillienKnightHpTable, this.shillienKnightMpTable, this.shillienKnightCpTable));
        classDataInfo.put(ClassID.bladedancer.getClassId(), new ClassDataInfo(this.bladedancerHpTable, this.bladedancerMpTable, this.bladedancerCpTable));
        classDataInfo.put(ClassID.abyss_walker.getClassId(), new ClassDataInfo(this.abyssWalkerHpTable, this.abyssWalkerMpTable, this.abyssWalkerCpTable));
        classDataInfo.put(ClassID.phantom_ranger.getClassId(), new ClassDataInfo(this.phantomRangerHpTable, this.phantomRangerMpTable, this.phantomRangerCpTable));
        classDataInfo.put(ClassID.dark_mage.getClassId(), new ClassDataInfo(this.darkMageHpTable, this.darkMageMpTable, this.darkMageCpTable));
        classDataInfo.put(ClassID.dark_wizard.getClassId(), new ClassDataInfo(this.darkWizardHpTable, this.darkWizardMpTable, this.darkWizardCpTable));
        classDataInfo.put(ClassID.shillien_oracle.getClassId(), new ClassDataInfo(this.shillienOracleHpTable, this.shillienOracleMpTable, this.shillienOracleCpTable));
        classDataInfo.put(ClassID.spellhowler.getClassId(), new ClassDataInfo(this.spellhowlerHpTable, this.spellhowlerMpTable, this.spellhowlerCpTable));
        classDataInfo.put(ClassID.phantom_summoner.getClassId(), new ClassDataInfo(this.phantomSummonerHpTable, this.phantomSummonerMpTable, this.phantomSummonerCpTable));
        classDataInfo.put(ClassID.shillien_elder.getClassId(), new ClassDataInfo(this.shillienElderHpTable, this.shillienElderMpTable, this.shillienElderCpTable));
        classDataInfo.put(ClassID.orc_fighter.getClassId(), new ClassDataInfo(this.orcFighterHpTable, this.orcFighterMpTable, this.orcFighterCpTable));
        classDataInfo.put(ClassID.orc_raider.getClassId(), new ClassDataInfo(this.orcRaiderHpTable, this.orcRaiderMpTable, this.orcRaiderCpTable));
        classDataInfo.put(ClassID.orc_monk.getClassId(), new ClassDataInfo(this.orcMonkHpTable, this.orcMonkMpTable, this.orcMonkCpTable));
        classDataInfo.put(ClassID.destroyer.getClassId(), new ClassDataInfo(this.destroyerHpTable, this.destroyerMpTable, this.destroyerCpTable));
        classDataInfo.put(ClassID.tyrant.getClassId(), new ClassDataInfo(this.tyrantHpTable, this.tyrantMpTable, this.tyrantCpTable));
        classDataInfo.put(ClassID.orc_mage.getClassId(), new ClassDataInfo(this.orcMageHpTable, this.orcMageMpTable, this.orcMageCpTable));
        classDataInfo.put(ClassID.orc_shaman.getClassId(), new ClassDataInfo(this.orcShamanHpTable, this.orcShamanMpTable, this.orcShamanCpTable));
        classDataInfo.put(ClassID.overlord.getClassId(), new ClassDataInfo(this.overlordHpTable, this.overlordMpTable, this.overlordCpTable));
        classDataInfo.put(ClassID.warcryer.getClassId(), new ClassDataInfo(this.warcryerHpTable, this.warcryerMpTable, this.warcryerCpTable));
        classDataInfo.put(ClassID.dwarven_fighter.getClassId(), new ClassDataInfo(this.dwarvenFighterHpTable, this.dwarvenFighterMpTable, this.dwarvenFighterCpTable));
        classDataInfo.put(ClassID.scavenger.getClassId(), new ClassDataInfo(this.scavengerHpTable, this.scavengerMpTable, this.scavengerCpTable));
        classDataInfo.put(ClassID.artisan.getClassId(), new ClassDataInfo(this.artisanHpTable, this.artisanMpTable, this.artisanCpTable));
        classDataInfo.put(ClassID.bounty_hunter.getClassId(), new ClassDataInfo(this.bountyHunterHpTable, this.bountyHunterMpTable, this.bountyHunterCpTable));
        classDataInfo.put(ClassID.warsmith.getClassId(), new ClassDataInfo(this.warsmithHpTable, this.warsmithMpTable, this.warsmithCpTable));
        classDataInfo.put(ClassID.dreadnought.getClassId(), new ClassDataInfo(this.dreadnoughtHpTable, this.dreadnoughtMpTable, this.dreadnoughtCpTable));
        classDataInfo.put(ClassID.duelist.getClassId(), new ClassDataInfo(this.duelistHpTable, this.duelistMpTable, this.duelistCpTable));
        classDataInfo.put(ClassID.phoenix_knight.getClassId(), new ClassDataInfo(this.phoenixKnightHpTable, this.phoenixKnightMpTable, this.phoenixKnightCpTable));
        classDataInfo.put(ClassID.hell_knight.getClassId(), new ClassDataInfo(this.hellKnightHpTable, this.hellKnightMpTable, this.hellKnightCpTable));
        classDataInfo.put(ClassID.adventurer.getClassId(), new ClassDataInfo(this.adventurerHpTable, this.adventurerMpTable, this.adventurerCpTable));
        classDataInfo.put(ClassID.sagittarius.getClassId(), new ClassDataInfo(this.sagittariusHpTable, this.sagittariusMpTable, this.sagittariusCpTable));
        classDataInfo.put(ClassID.archmage.getClassId(), new ClassDataInfo(this.archmageHpTable, this.archmageMpTable, this.archmageCpTable));
        classDataInfo.put(ClassID.soultaker.getClassId(), new ClassDataInfo(this.soultakerHpTable, this.soultakerMpTable, this.soultakerCpTable));
        classDataInfo.put(ClassID.arcana_lord.getClassId(), new ClassDataInfo(this.arcanaLordHpTable, this.arcanaLordMpTable, this.arcanaLordCpTable));
        classDataInfo.put(ClassID.cardinal.getClassId(), new ClassDataInfo(this.cardinalHpTable, this.cardinalMpTable, this.cardinalCpTable));
        classDataInfo.put(ClassID.hierophant.getClassId(), new ClassDataInfo(this.hierophantHpTable, this.hierophantMpTable, this.hierophantCpTable));
        classDataInfo.put(ClassID.eva_templar.getClassId(), new ClassDataInfo(this.evasTemplarHpTable, this.evasTemplarMpTable, this.evasTemplarCpTable));
        classDataInfo.put(ClassID.sword_muse.getClassId(), new ClassDataInfo(this.swordMuseHpTable, this.swordMuseMpTable, this.swordMuseCpTable));
        classDataInfo.put(ClassID.wind_rider.getClassId(), new ClassDataInfo(this.windRiderHpTable, this.windRiderMpTable, this.windRiderCpTable));
        classDataInfo.put(ClassID.moonlight_sentinel.getClassId(), new ClassDataInfo(this.moonlightSentinelHpTable, this.moonlightSentinelMpTable, this.moonlightSentinelCpTable));
        classDataInfo.put(ClassID.mystic_muse.getClassId(), new ClassDataInfo(this.mysticMuseHpTable, this.mysticMuseMpTable, this.mysticMuseCpTable));
        classDataInfo.put(ClassID.elemental_master.getClassId(), new ClassDataInfo(this.elementalMasterHpTable, this.elementalMasterMpTable, this.elementalMasterCpTable));
        classDataInfo.put(ClassID.eva_saint.getClassId(), new ClassDataInfo(this.evasSaintHpTable, this.evasSaintMpTable, this.evasSaintCpTable));
        classDataInfo.put(ClassID.shillien_templar.getClassId(), new ClassDataInfo(this.shillienTemplarHpTable, this.shillienTemplarMpTable, this.shillienTemplarCpTable));
        classDataInfo.put(ClassID.spectral_dancer.getClassId(), new ClassDataInfo(this.spectralDancerHpTable, this.spectralDancerMpTable, this.spectralDancerCpTable));
        classDataInfo.put(ClassID.ghost_hunter.getClassId(), new ClassDataInfo(this.ghostHunterHpTable, this.ghostHunterMpTable, this.ghostHunterCpTable));
        classDataInfo.put(ClassID.ghost_sentinel.getClassId(), new ClassDataInfo(this.ghostSentinelHpTable, this.ghostSentinelMpTable, this.ghostSentinelCpTable));
        classDataInfo.put(ClassID.storm_screamer.getClassId(), new ClassDataInfo(this.stormScreamerHpTable, this.stormScreamerMpTable, this.stormScreamerCpTable));
        classDataInfo.put(ClassID.spectral_master.getClassId(), new ClassDataInfo(this.spectralMasterHpTable, this.spectralMasterMpTable, this.spectralMasterCpTable));
        classDataInfo.put(ClassID.shillien_saint.getClassId(), new ClassDataInfo(this.shillienSaintHpTable, this.shillienSaintMpTable, this.shillienSaintCpTable));
        classDataInfo.put(ClassID.titan.getClassId(), new ClassDataInfo(this.titanHpTable, this.titanMpTable, this.titanCpTable));
        classDataInfo.put(ClassID.grand_khauatari.getClassId(), new ClassDataInfo(this.grandKhavatariHpTable, this.grandKhavatariMpTable, this.grandKhavatariCpTable));
        classDataInfo.put(ClassID.dominator.getClassId(), new ClassDataInfo(this.dominatorHpTable, this.dominatorMpTable, this.dominatorCpTable));
        classDataInfo.put(ClassID.doomcryer.getClassId(), new ClassDataInfo(this.doomcryerHpTable, this.doomcryerMpTable, this.doomcryerCpTable));
        classDataInfo.put(ClassID.fortune_seeker.getClassId(), new ClassDataInfo(this.fortuneSeekerHpTable, this.fortuneSeekerMpTable, this.fortuneSeekerCpTable));
        classDataInfo.put(ClassID.maestro.getClassId(), new ClassDataInfo(this.maestroHpTable, this.maestroMpTable, this.maestroCpTable));
        classDataInfo.put(ClassID.kamael_m_soldier.getClassId(), new ClassDataInfo(this.kamaelMSoldierHpTable, this.kamaelMSoldierMpTable, this.kamaelMSoldierCpTable));
        classDataInfo.put(ClassID.trooper.getClassId(), new ClassDataInfo(this.trooperHpTable, this.trooperMpTable, this.trooperCpTable));
        classDataInfo.put(ClassID.berserker.getClassId(), new ClassDataInfo(this.berserkerHpTable, this.berserkerMpTable, this.berserkerCpTable));
        classDataInfo.put(ClassID.m_soul_breaker.getClassId(), new ClassDataInfo(this.mSoulBreakerHpTable, this.mSoulBreakerMpTable, this.mSoulBreakerCpTable));
        classDataInfo.put(ClassID.doombringer.getClassId(), new ClassDataInfo(this.doombringerHpTable, this.doombringerMpTable, this.doombringerCpTable));
        classDataInfo.put(ClassID.m_soul_hound.getClassId(), new ClassDataInfo(this.mSoulHoundHpTable, this.mSoulHoundMpTable, this.mSoulHoundCpTable));
        classDataInfo.put(ClassID.kamael_f_soldier.getClassId(), new ClassDataInfo(this.kamaelFSoldierHpTable, this.kamaelFSoldierMpTable, this.kamaelFSoldierCpTable));
        classDataInfo.put(ClassID.warder.getClassId(), new ClassDataInfo(this.warderHpTable, this.warderMpTable, this.warderCpTable));
        classDataInfo.put(ClassID.arbalester.getClassId(), new ClassDataInfo(this.arbalesterHpTable, this.arbalesterMpTable, this.arbalesterCpTable));
        classDataInfo.put(ClassID.f_soul_breaker.getClassId(), new ClassDataInfo(this.fSoulBreakerHpTable, this.fSoulBreakerMpTable, this.fSoulBreakerCpTable));
        classDataInfo.put(ClassID.trickster.getClassId(), new ClassDataInfo(this.tricksterHpTable, this.tricksterMpTable, this.tricksterCpTable));
        classDataInfo.put(ClassID.f_soul_hound.getClassId(), new ClassDataInfo(this.fSoulHoundHpTable, this.fSoulHoundMpTable, this.fSoulHoundCpTable));
        classDataInfo.put(ClassID.inspector.getClassId(), new ClassDataInfo(this.inspectorHpTable, this.inspectorMpTable, this.inspectorCpTable));
        classDataInfo.put(ClassID.judicator.getClassId(), new ClassDataInfo(this.judicatorHpTable, this.judicatorMpTable, this.judicatorCpTable));
