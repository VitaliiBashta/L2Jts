package org.jts.dataparser.data.holder.dyedata;
...
public class DyeData {
    ...
    public int wit; // WIT
    @IntValue
    public int need_count; // Необходимое кол-во таких предметов для нанесения
    // тату
    @IntValue
    public int wear_fee; // Вероятно, цена нанесения
    @IntValue
    public int cancel_count; // Количество предметов, возвращаемое при снятии
    // тату
    @IntValue
