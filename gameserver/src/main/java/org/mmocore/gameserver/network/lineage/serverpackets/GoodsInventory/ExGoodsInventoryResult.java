...
public class ExGoodsInventoryResult extends GameServerPacket {
    ...
    public static final GameServerPacket SUCCESS = new ExGoodsInventoryResult(2);
    public static GameServerPacket ERROR = new ExGoodsInventoryResult(-1);
    public static final GameServerPacket TRY_AGAIN_LATER = new ExGoodsInventoryResult(-2);
    public static final GameServerPacket INVENTORY_FULL = new ExGoodsInventoryResult(-3);
    public static final GameServerPacket NOT_CONNECT_TO_PRODUCT_SERVER = new ExGoodsInventoryResult(-4);
    public static final GameServerPacket CANT_USE_AT_TRADE_OR_PRIVATE_SHOP = new ExGoodsInventoryResult(-5);
    public static final GameServerPacket NOT_EXISTS = new ExGoodsInventoryResult(-6);
    ...
    public static final GameServerPacket PREVIOS_REQUEST_IS_NOT_COMPLETE = new ExGoodsInventoryResult(-103);
