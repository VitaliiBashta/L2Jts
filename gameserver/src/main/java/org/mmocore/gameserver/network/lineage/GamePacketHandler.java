...
import org.jts.protection.network.clientpackets.RequestGameGuardQuery;
import org.mmocore.commons.net.nio.impl.*;
...
import org.mmocore.gameserver.network.lineage.clientpackets.ItemModification.RefineStone.*;
import org.mmocore.gameserver.network.lineage.clientpackets.Moving.*;
import org.mmocore.gameserver.network.lineage.clientpackets.PremiumShop.*;
            ...
            case CONNECTED:
                switch (id) {
                    ...
                    case 0xcb:
                        ...
                        msg = new RequestGameGuardQuery(); //Protection
                        break;
                    default:
