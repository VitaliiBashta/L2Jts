...
public enum SystemMsg implements IBroadcastPacket {
    // Special null system message, does not sent to client
    NULL(0),
    // Message: The server will be coming down in $s1 seconds. Please find a safe place to log out.
    ...
    // Message: Your title cannot exceed 16 characters in length.В  Please try again.
    ...
    INVALID_TARGET(109),
    // Message: $s1вЂ™s effect can be felt.
    ...
    // Message: $s1 has been added to your friend list.
    S1_HAS_BEEN_ADDED_TO_YOUR_FRIEND_LIST(132),
    ...
    // Message: HP was fully recovered and skill was removed.
    HP_WAS_FULLY_RECOVERED_AND_SKILL_WAS_REMOVED(175),
    ...
    THE_ACADEMY_ROYAL_GUARD_ORDER_OF_KNIGHTS_IS_FULL_AND_CANNOT_ACCEPT_NEW_MEMBERS_AT_THIS_TIME(233),
    ...
    // Message: You received $s1 damage because you were unable to breathe.
    ...
    // Message: You are unable to unlock the door.
    YOU_ARE_UNABLE_TO_UNLOCK_THE_DOOR(319),
    // Message: You have failed to unlock the door.
    YOU_HAVE_FAILED_TO_UNLOCK_THE_DOOR(320),
    // Message: Its not locked.
    ...
    // Message: Cannot connection to petition server.
    CANNOT_CONNECT_TO_PETITION_SERVER(381),
    // Message: Ending petition consultation.
    ENDING_PETITION_CONSULTATION(387),
    // Message: Not under petition consultation.
    NOT_UNDER_PETITION_CONSULTATION(388),
    // Message: Petition application accepted receipt no is $s1.
    PETITION_APPLICATION_ACCEPTED_RECEIPT_NO_IS_S1(389),
    ...
    // Message: A clan that has withdraw or been expelled cannot enter into an alliance within one day of withdrawal or expulsion.
    ...
    AFFILIATED_CLANS_TOTAL_S1_CLAN_S(495),
    // Message: =====<Clan Information>=====
    _CLAN_INFORMATION_(496),
    ...
    // Message: You cannot create a new alliance within 1 day after dissolution.
    YOU_CANNOT_CREATE_A_NEW_ALLIANCE_WITHIN_1_DAY_AFTER_DISSOLUTION(505),
    // Message: Incorrect alliance name.
    ...
    // Message: You cannot disperse the clans in you alliance.
    ...
    // Message: There are $s1 petition pending.
    THERE_ARE_S1_PETITIONS_PENDING(601),
    // Message: The petition system is currently inavailable. Please try again later.
    ...
    // Message: You have failed to delete the character from your Ignore List.
    ...
    YOU_HAVE_SUBMITTED_S1_PETITIONS_S2(730),
    ...
    THE_PETITION_WAS_CANCELED_S1(736),
    ...
    THIS_WEEK_USAGE_TIME_HAS_FINISHED(756),
    // Message: There are $s1 hours and $s2 minutes left in the fixed use time.
    THERE_ARE_S1_HOURS_AND_S2_MINUTES_LEFT_IN_THIS_FIXED_USE_TIME(757),
    ...
    S1_CANNOT_JOIN_THE_CLAN_BECAUSE_ONE_DAY_HAS_NOT_YET_PASSED_SINCE_HE_SHE_LEFT_ANOTHER_CLAN(760),
    ...
    YOU_HAVE_BEEN_PLAYING_FOR_AN_EXTENDED_PERIOD_OF_TIME_S1_PLEASE_CONSIDER_TAKING_A_BREAK(764),
    ...
    FIRST_PRIZE_GOES_TO_THE_PLAYER_IN_LANE_S1_S2(826),
    ...
    // Message: The recipe is incorrest.
    ...
    THE_FERRY_WILL_LEAVE_FOR_GLUDIN_HARBOR_IN_ONE_MINUTES(982),
    // Message: Those wishing to ride the ferry should make haste to get on.
    THOSE_WICHING_TO_RIDE_THE_FERRY_SHOULD_MAKE_HASTE_TO_GET_ON(983),
    ...
    THE_FERRY_WILL_LEAVE_FOR_TALKING_ISLAND_HARBOR_IN_ONE_MINUTES(989),
    ...
    THE_INNADRIL_PLEASURE_BOAT_WILL_LIEAVE_IN_FIVE_MINUTES(999),
    // Message: The Innadril pleasure boat will leave in one minute.
    THE_INNADRIL_PLEASURE_BOAT_WILL_LIEAVE_IN_ONE_MINUTES(1000),
    ...
    YOU_HAVE_EXCEEDED_THE_STORAGE_CAPACITY_OF_THE_CASTLE_S_VAULT(1056),
    ...
    THE_SALES_PRICE_FOR_SEEDS_IS_$S1_ADENA(1058),
    // Message: The remaining purchasing amount is $s1 adena.
    THE_REMAINING_PURCHASING_AMOUNT_IS_$S1_ADENA(1059),
    ...
    THE_RECIPE_CANNOT_BE_REGISTERED_YOU_DO_NOT_HAVE_THE_ABILITY_TO_CREATE_ITEMS(1061),
    ...
    THE_PETITION_SERVICE_IS_CURRENTLYO_UNAVAILABLE_PLEASE_TRY_AGAIN_LATER(1063),
    ...
    // Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 5 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_TALKING_ISLAND_IN_APPROXIMATELY_1_MINUTES(1193),
    ...
    // Message: = $s1 (Альянс $s2)
    S1_S2_ALLIANCE(1200),
    // Message: = $s1 (Альянс $s2)
    S1_NO_ALLIANCE_EXISTS(1202),
    ...
    // Message: You have sent mail.
    YOU_HAVE_SENT_MAIL(1231),
    // Message: The message was not sent.
    THE_MESSAGE_WAS_NOT_SENT(1232),
    // Message: You have got mail.
    YOU_HAVE_GOT_MAIL(1233),
    ...
    // Message: Used only during a quest event period.
    USED_ONLY_DURING_A_QUEST_EVENT_PERIOD(1303),
    ...
    THE_USE_OF_S1_WILL_NOW_BE_AUTOMATED(1433),
    ...
    // Message: does not meet the participation requirements. A subclass character cannot participate in the Olympiad.
    DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_SUBCLASS_CHARACTER_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD(1500),
    // Message: does not meet the participation requirements. Only Noblesse characters can participate in the Olympiad.
    DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_ONLY_NOBLESSE_CHARACTERS_CAN_PARTICIPATE_IN_THE_OLYMPIAD(1501),
    ...
    C1_DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD_BECAUSE_YOUR_INVENTORY_SLOT_EXCEEDS_80_PERCENT(1691),
    ...
    C1_DOES_NOT_MEET_THE_PARTICIPATION_REQUIREMENTS_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD_BECAUSE_YOU_HAVE_CHANGE_TO_YOUR_SUB_CLASS(1692),
    ...
    THE_REQUEST_CANNOT_BE_COMPLETED_BACAUSE_THE_REQUIREMENTS_ARE_NOT_MET_IN_ORDER_TO_PARTICIPATE_IN_A_TEAM_MATCH_ALL_TEAM_MEMBERS_MUST_HAVE_AN_OLYMPIAD_SCORE_OF_1_OR_MORE(2941),
    ...
    // Message: Notice has been saved.
    NOTICE_HAS_BEEN_SAVED(1556),
    ...
    // Message: $s1 party has left the command channel.
    S1_PARTY_HAS_LEFT_THE_COMMAND_CHANNEL(1587),
    ...
    // Message: You have completed the quest for 3rd occupation change and moved to another class congratulations.
    YOU_HAVE_COMPLETED_THE_QUEST_FOR_3RD_OCCUPATION_CHANGE_AND_MOVED_TO_ANOTHER_CLASS_CONGRATULATIONS(1606),
    ...
    DEPARTURE_FOR_GIRAN_HARBOR_WILL_TAKE_PLACE_IN_ONE_MINUTE(1622),
    // Message: Make haste!  We will be departing for Gludin Harbor shortly…
    MAKE_HASTE_WE_WILL_BE_DEPARTING_FOR_GLUDIN_HARBOR_SHORTLY(1623),
    ...
    // Message: Make haste!  We will be departing for Rune Harbor shortly…
    MAKE_HASTE_WE_WILL_BE_DEPARTING_FOR_RUNE_HARBOR_SHORTLY(1628),
    ...
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPOXIMATELY_15_MINUTES(1630),
    // Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 10 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPOXIMATELY_10_MINUTES(1631),
    // Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 5 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPOXIMATELY_5_MINUTES(1632),
    // Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 1 minute.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_GLUDIN_HARBOR_IN_APPOXIMATELY_1_MINUTES(1633),
    // Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 15 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPOXIMATELY_15_MINUTES(1634),
    // Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 10 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPOXIMATELY_10_MINUTES(1635),
    // Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 5 minutes.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPOXIMATELY_5_MINUTES(1636),
    // Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 1 minute.
    THE_FERRY_FROM_GLUDIN_HARBOR_WILL_BE_ARRIVING_AT_RUNE_HARBOR_IN_APPOXIMATELY_1_MINUTES(1637),
    ...
    // Message: You play: $s1 h $s2 min. Needs to rest: $s3 h $s4 min.
    YOU_PLAY_S1_S2_NEEDS_TO_REST_S3_S4(1644),
    ...
    // Message: Since your clan emerged victorious from the siege, $s1 points have been added to your clan's reputation score.
    CLAN_MEMBER_S1_WAS_AN_ACTIVE_MEMBER_OF_THE_HIGHEST_RANKED_PARTY_IN_THE_FESTIVAL_OF_DARKNESS_S2_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE(1775),
    // Message: Clan member $c1 was named a hero. $2s points have been added to your clan's reputation score.
    CLAN_MEMBER_S1_WAS_NAMED_A_HERO_S2_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE(1776),
    // Message: You have successfully completed a clan quest. $s1 points have been added to your clan's reputation score.
    YOU_HAVE_SUCCESSFULLY_COMPLETED_A_CLAN_QUEST_S1_POINTS_HAVE_BEEN_ADDED_TO_YOUR_CLAN_REPUTATION_SCORE(1777),
    ...
    YOU_HAVE_AVOIDED_C1S_ATTACK(2000),
    ...
    THERE_ARE_S1_HOURSS_AND_S2_MINUTES_REMAINING_UNTIL_THE_TIME_WHEN_THE_ITEM_CAN_BE_PURCHASED(2034),
    // Message: There are $s1 minute(s) remaining until the item can be purchased again.
    THERE_ARE_S1_MINUTES_REMAINING_UNTIL_THE_TIME_WHEN_THE_ITEM_CAN_BE_PURCHASED(2035),
    ...
    // Message: Some Lineage II features have been limited for free trials.Р’В Trial accounts arenРІР‚в„ўt allowed buy items from private stores.Р’В To unlock all of the features of Lineage II, purchase the full version today.
    ...
    YOU_CANNOT_POLYMORPH_WHEN_YOU_HAVE_SUMMONED_A_SERVITOR_PET(2062),
    ...
    SOME_LINEAGE_II_FEATURES_HAVE_BEEN_LIMITED_FOR_FREE_TRIALS_TRIAL_ACCOUNT_HAVE_LIMITED_CHATTING_CAPABILITIES_TO_UNLOCK_ALL_OF_THE_FEATURES_OF_LINEAGE_II_PURCHASE_THE_FULL_VERSION_TODAY(2095),
    ...
    THIS_INSTANCE_ZONE_WILL_BE_TERMINATED_IN_S1_MINUTES_YOU_WILL_BE_FORCED_OUT_OF_THE_DANGEON_THEN_TIME_EXPIRES(2107),
    ...
    BIDDER_EXISTS_THE_AUCTION_TIME_HAS_BEEN_EXTENDED_BY_3_MINUTES(2160),
    ...
    // Message: Its too far from the NPC to work.
    ITS_TOO_FAR_FROM_THE_NPC_TO_WORK(2193),
    ...
    // Message: The pet can run away if the hunger gauge is below 10%
    THE_PET_CAN_RUN_AWAY_IF_THE_HUNGER_GAUGE_IS_BELOW_10(2260),
    ...
    YOU_HAVE_USED_A_REPORT_POINT_ON_$C1_YOU_HAVE_$S2_POINTS_REMAINING_ON_THIS_ACCOUNT(2468),
    ...
    YOU_VE_ACQUIRED_THE_WARD_MOVE_QUICKLY_TO_YOUR_FORCES_OUTPOST(2902),
    ...
    YOU_CANNOT_FORWARD_IN_A_NON_PEACE_ZONE_LOCATION(2970),
    ...
    YOU_CANNOT_RECEIVE_IN_A_NON_PEACE_ZONE_LOCATION(2976),
    ...
    YOU_CANNOT_CANCEL_IN_A_NON_PEACE_ZONE_LOCATION(2982),
    ...
    SHYEED_S_ROAR_FILLED_WITH_WRATH_RINGS_THROUGHOUT_THE_STAKATO_NEST(3007),
    ...
    THE_KASHA_S_EYE_GIVES_YOU_A_STRANGE_FEELING(3022),
    // Message: I can feel that the energy being flown in the kasha's eye is getting stronger rapidly.
    I_CAN_FEEL_THAT_THE_ENERGY_BEING_FLOWN_IN_THE_KASHA_S_EYE_IS_GETTING_STRONGER_RAPIDLY(3023),
    // Message: Kasha's eye pithes and tosses like it's about to explode.
    KASHA_S_EYE_PITCHES_AND_TOSSES_LIKE_IT_S_ABOUT_TO_EXPLODE(3024),
    ...
    BY_USING_THE_SKILL_OF_EINHASAD_S_HOLY_SWORD_DEFEAT_THE_EVIL_LILIMS(3031),
    ...
    IN_ORDER_TO_HELP_ANAKIM_ACTIVATE_THE_SEALING_DEVICE_OF_THE_EMPEROR_WHO_IS_POSSESED_BY_THE_EVIL(3032),
    // Message: By using the invisible skill sneak into the dawn's document storage.
    BY_USING_THE_INVISIBLE_SKILL_SNEAK_INTO_THE_DAWN_S_DOCUMENT_STORAGE(3033),
    // Message: The door in front of us is the entrance to the dawn's document storage approach to the code.
    THE_DOOR_IN_FRONT_OF_US_IS_THE_ENTRANCE_TO_THE_DAWN_S_DOCUMENT_STORAGE_APPROACH_TO_THE_CODE(3034),
    ...
    BY_USING_THE_COURT_MAGICIAN_S_MAGIC_STAFF_OPEN_THE_DOOR_ON_WHICH_THE_MAGICIAN_S_BARRIER_IS(3040),
    ...
    YOU_CANNOT_RECEIVE_OR_SEND_MAIL_WITH_ATTACHED_ITEMS_IN_NON_PEACE_ZONE_REGIONS(3066),
    ...
    WHEN_YOUR_PETS_HUNGER_GAUGE_IS_AT_0_PERCENT_YOU_CANNOT_USE_YOUR_PET(3212),
    ...
    FREE_ACOUNTS_BELOW_LEVEL_20_CANNOT_SHOUT_OR_ENGAGE_IN_BUY_SELL_CHATTING(3282),
    // Message: The item cannot be received because the inventory weight/quantity limit has been exceeded.
    THE_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHT_QUANTITY_LIMIT_HAS_BEEN_EXCEEDED(6006),
    // Message: You acquired $s1 Exp. and $s2 SP. (As a reward you receive $s3% more Exp.)
    YOU_ACQUIRED_S1_EXP_AND_S2_SP_AS_A_REWARD_YOU_RECEIVE_S3_MORE_EXP(6011),
    // Message: a blessing that increases Exp. by $1 $2
    A_BLESSING_THAT_INCREASES_EXP_BY_S1_S2(6012),
    // Message: It is not a blessing period. When you reach today's target, you can receive $s1%.
    IT_IS_NOT_A_BLESSING_PERIOD_WHEN_YOU_REACH_TODAYS_TARGET_YOU_CAN_RECEIVE_S1(6013),
    // Message: It is Eva's blessing period. $s1% will be effective until $s2.
    IT_IS_EVAS_BLESSING_PERIOD_S1_WILL_BE_EFFECTIVE_UNTIL_S2(6014),
    // Message: It is Eva's blessing period. Until $s1, Jack Sage can gift you with $s2%.
    IT_IS_EVAS_BLESSING_PERIOD_UNTIL_S1_JACK_SAGE_CAN_GIFT_YOU_WITH_S2(6015),
    // Message: Progress: Event stage $s1.
    PROGRESS_EVENT_STAGE_S1(6016),
    // Message: Eva's Blessing Stage $s1 has begun. a,It is Eva's blessing period
    EVAS_BLESSING_STAGE_S1_HAS_BEGUN(6017),
    // Message: Eva's Blessing Stage $s1 has ended. a,Currently it is not the blessing period.
    ...
    THE_PREMIUM_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHT_QUANTITY_LIMIT_HAS_BEEN_EXCEEDED(6047),
    ...
    // Message: The first gift's remaining resupply time is $s1 hour(s) $s2 minute(s) $s3 second(s). (If you resummon the Agathion at the gift supply time, the supply time can take an additional 10
    // minutes.)
    ...
    // Message: The second gift's remaining resupply time is $s1 hour(s) $s2 minute(s) $s3 second(s). (If you resummon the Agathion at the gift supply time, the supply time can take an additional 1
    // hour 10 minutes.)
    THE_SECOND_GIFTS_REMAINING_RESUPPLY_TIME_IS_S1_HOURS_S2_MINUTES_S3_SECONDS(2945),
    // Message: The second gift's remaining resupply time is $s1 minute(s) $s2 second(s). (If you resummon the Agathion at the gift supply time, the supply time can take an additional 1 hour 10
    // minutes.)
    ...
    private final GameServerPacket _message;
    ...
    SystemMsg(final int i) {
        ...
        if (name().contains("S4") || name().contains("C4")) {
            ...
            _size = 0;
            _message = _id != 0 ? new SystemMessage(this) : null;
        }
    }
