...
public class CharacterFriendDAO {
    ...
    public void insert(final Player owner, final Player friend) {
        ...
        try {
            ...
            _log.warn(owner.getFriendComponent() + " could not add friend objectid: " + friend.getObjectId(), e);
        } finally {
    ...
    public void delete(final Player owner, final int friend) {
        ...
        try {
            ...
            _log.warn("FriendSystem: could not delete friend objectId: " + friend + " ownerId: " + owner.getObjectId(), e);
        } finally {
            DbUtils.closeQuietly(con, statement);
        }
    }
