...
public class MailDAO implements JdbcDAO<Integer, Mail> {
    ...
    private final Cache<Integer, Mail> cache = GameServer.getInstance().getCacheManager().getCache(getClass().getName());
    ...
    public Cache<Integer, Mail> getCache() {
        return cache;
    }
    ...
    public List<Mail> load(final Collection<Integer> messageIds) {
        ...
        final List<Mail> list = new ArrayList<>(messageIds.size());
