...
import org.mmocore.gameserver.scripts.instances.CastlePrison;
...
public final class CastlePrisonKeeperInstance extends NpcInstance {
    ...
    private String checkConditions(Player p) {
        ...
        if (castle.getSiegeDate().toEpochSecond() == 0)
            return "residence2/castle/castle_prison_keeper07.htm"; //cannot enter if siege date isn't defined
        long timeToSiege = (castle.getSiegeDate().toEpochSecond() * 1000) - System.currentTimeMillis();
        long timeToTWSiege = (castle.getDominion().getSiegeDate().toEpochSecond() * 1000) - System.currentTimeMillis();
