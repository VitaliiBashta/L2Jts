...
public class SeedOfAnnihilation implements OnInitScriptListener {
    ...
    public void loadSeedRegionData() {
        ...
        _regionsData[0] = new SeedRegion(new String[]{
                "[14_23_beastacon_for_melee_for_pc]", "[14_23_beastacon_for_archer_for_pc]", "[14_23_beastacon_for_mage_for_pc]"
        }, new String[]{"[14_23_beastacon_for_melee]", "[14_23_beastacon_for_archer]", "[14_23_beastacon_for_mage]"}, new int[][]{
                {-180450, 185507, -10574, 11632},
                {-180005, 185489, -10577, 11632}
        }); // Bistakon data
        _regionsData[1] = new SeedRegion(new String[]{
                "[14_23_raptilicon_for_melee_for_pc]", "[14_23_raptilicon_for_archer_for_pc]", "[14_23_raptilicon_for_mage_for_pc]"
        }, new String[]{"[14_23_raptilicon_for_melee]", "[14_23_raptilicon_for_archer]", "[14_23_raptilicon_for_mage]"}, new int[][]{
                {-179600, 186998, -10737, 11632},
                {-179295, 186444, -10733, 11632}
        }); // Reptilikon data
        _regionsData[2] = new SeedRegion(new String[]{
                "[13_23_cocracon_for_melee_for_pc]", "[13_23_cocracon_for_archer_for_pc]", "[13_23_cocracon_for_mage_for_pc]"
        }, new String[]{"[13_23_cocracon_for_melee]", "[13_23_cocracon_for_archer]", "[13_23_cocracon_for_mage]"}, new int[][]{
                {-180971, 186361, -10557, 11632},
                {-180758, 186739, -10556, 11632}
        }); // Cokrakon data
                    ...
                    for (NpcInstance npc : around) {
                        if (npc.getNpcId() == 32738 && npc.getFollowTarget() != null) {
                            if (npc.getFollowTarget().getObjectId() == cha.getObjectId()) {
                                ...
                                npc.getAI().setIntention(CtrlIntention.AI_INTENTION_FOLLOW, cha, AllSettingsConfig.FOLLOW_RANGE);
                            }
                        }
                    }
                }
