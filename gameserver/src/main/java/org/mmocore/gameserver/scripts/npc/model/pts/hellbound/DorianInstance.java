 ...
 * @author KilRoy
 */
public class DorianInstance extends NpcInstance {
    private static final int pos_x = -13400;
    private static final int pos_y = 272827;
    private static final int pos_z = -15300;

    public DorianInstance(int objectId, NpcTemplate template) {
                ...
                if (i0 >= 11) {
                    if (player.getParty() == null || !player.getParty().isLeader(player)) {
                        ...
                        if (i1 == 0) {
                            ...
                            showChatWindow(player, "pts/hellbound/dorian002.htm");
                        }
                    }
                } else {
