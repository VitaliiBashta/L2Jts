 ...
 * Через 15 секунд исчезают все жаровни. - Запускается евент и комната респавнится с монстрами лукарями.
...
public class FurnaceProtection extends DefaultAI {
    ...
    public FurnaceProtection(NpcInstance actor) {
        ...
        actor.setNameNpcString(NpcString.FURNACE_OF_PROTECTION);
