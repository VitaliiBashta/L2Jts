...
public class BanditMessagerInstance extends NpcInstance {
    ...
    private boolean checkCond(Player player, boolean regMenu) {
        ...
        if (siegeEvent.isRegistrationOver()) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_504_CompetitionForTheBanditStronghold/azit_messenger_q0504_03.htm", "%siege_time%", TimeUtils.dateTimeFormat(clanHall.getSiegeDate()));
            return false;
        }
        ...
        if (clan == null || player.getObjectId() != clan.getLeaderId()) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_504_CompetitionForTheBanditStronghold/azit_messenger_q0504_05.htm");
            return false;
        }

        if (player.getObjectId() == clan.getLeaderId() && clan.getLevel() < 4) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_504_CompetitionForTheBanditStronghold/azit_messenger_q0504_04.htm");
            return false;
        }
        ...
        if (clan.getHasHideout() > 0) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_504_CompetitionForTheBanditStronghold/azit_messenger_q0504_10.htm");
            return false;
        }
