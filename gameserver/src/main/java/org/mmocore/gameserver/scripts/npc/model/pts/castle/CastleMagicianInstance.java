package org.mmocore.gameserver.scripts.npc.model.pts.castle;
...
public class CastleMagicianInstance extends NpcInstance {
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        if (condition == COND_BUSY_BECAUSE_OF_SIEGE) {
            ...
            showChatWindow(player, "pts/castle/court_magician002.htm");
            return;
        }
		/*
		//TODO: Надо ли?
		...
		*/
        else if (command.startsWith("menu_select?ask=-301&")) {
            int i1 = 0;
            ...
            if (condition == COND_OWNER) {
                ...
                if (clanLeader != null) {
                    if (clanLeader.getEffectList().getEffectsBySkillId(3632) != null) {
                        ...
                        showChatWindow(player, "pts/castle/court_magician003.htm");
                    }
                } else {
                    showChatWindow(player, "pts/castle/court_magician003.htm");
                }
    ...
    public void showChatWindow(Player player, int val, Object... arg) {
        ...
        if (condition == COND_BUSY_BECAUSE_OF_SIEGE) {
            ...
            showChatWindow(player, "pts/castle/court_magician001.htm");
        } else {
            showChatWindow(player, "pts/castle/court_magician002.htm");
        }
    }
