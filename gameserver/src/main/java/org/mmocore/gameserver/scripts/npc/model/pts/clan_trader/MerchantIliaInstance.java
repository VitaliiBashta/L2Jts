...
public final class MerchantIliaInstance extends NpcInstance {
    // dialogs
    private static final String fnNoPledge = "pts/clan_trader/clan_merchant_ilia004.htm";
    private static final String fnPledgeFameValue = "pts/clan_trader/clan_merchant_ilia005.htm";
    private static final String fnNotEnoughItem = "pts/clan_trader/clan_merchant_ilia006.htm";
    private static final String fnUpdateFameSuccess = "pts/clan_trader/clan_merchant_ilia007.htm";
    private static final String fnLowerPledgeLvReq = "pts/clan_trader/clan_merchant_ilia008.htm";
    // multisell
    ...
    public MerchantIliaInstance(int objectId, NpcTemplate template) {
        ...
        switch (getNpcId()) {
            case 32025:
                if (player.getClan() != null && (player.isClanLeader() || (player.getClanPrivileges() & Clan.CP_CL_TROOPS_FAME) == Clan.CP_CL_TROOPS_FAME))
                    ...
                    showChatWindow(player, "pts/clan_trader/clan_merchant_ilia002.htm");
                break;
            default:
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        if (command.startsWith("menu_select?ask=-302&")) {
            if (command.endsWith("reply=-1")) {
                ...
                showChatWindow(player, "pts/clan_trader/clan_merchant_ilia003.htm");
