...
public class FarmMessengerInstance extends NpcInstance {
    ...
    private boolean checkCond(Player player, boolean regMenu) {
        ...
        if (siegeEvent.isRegistrationOver()) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_655_AGrandPlanForTamingWildBeasts/farm_messenger_q0655_11.htm", "%siege_time%", TimeUtils.dateTimeFormat(clanHall.getSiegeDate()));
            return false;
        }
        ...
        if (clan == null || player.getObjectId() != clan.getLeaderId()) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_655_AGrandPlanForTamingWildBeasts/farm_messenger_q0655_03.htm");
            return false;
        }

        if (player.getObjectId() == clan.getLeaderId() && clan.getLevel() < 4) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_655_AGrandPlanForTamingWildBeasts/farm_messenger_q0655_05.htm");
            return false;
        }
        ...
        if (clan.getHasHideout() > 0) {
            showChatWindow(player, "org/mmocore/gameserver/scripts/quests/_655_AGrandPlanForTamingWildBeasts/farm_messenger_q0655_04.htm");
            return false;
        }
