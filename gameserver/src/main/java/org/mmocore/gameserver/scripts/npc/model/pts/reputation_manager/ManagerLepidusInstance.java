...
public final class ManagerLepidusInstance extends NpcInstance {
    // dialogs
    private static final String fnNoPvpPoint = "pts/reputation_manager/pvp_merchant_lepidus002.htm";
    private static final String fnNoPledge = "pts/reputation_manager/pvp_merchant_lepidus004.htm";
    private static final String fnFameUpSuccess = "pts/reputation_manager/pvp_merchant_lepidus005.htm";
    private static final String fnNoPkCount = "pts/reputation_manager/pvp_merchant_lepidus006.htm";
    private static final String fnPkDownSuccess = "pts/reputation_manager/pvp_merchant_lepidus007.htm";
    // multisell
    ...
    public ManagerLepidusInstance(int objectId, NpcTemplate template) {
            ...
            case 36479:
                if (player.getFame() > 0) {
                    if ((player.getPlayerClassComponent().getClassId().isOfLevel(ClassLevel.Third) || player.getPlayerClassComponent().getClassId().isOfLevel(ClassLevel.Fourth)) && player.getLevel() >= 40)
                        showChatWindow(player, "pts/reputation_manager/pvp_merchant_lepidus001.htm");
                    else
