...
public class _123_TheLeaderAndTheFollower extends Quest {
    final int NEWYEAR = 31961;
    final int BRUIN_LIZARDMEN = 27321;
    final int BRUIN_BLOOD = 8549;
    final int PICOT_ARANEID = 27322;
    final int PICOT_LEG = 8550;
    final int D_CRY = 1458;
    final int D_CRY_COUNT_HEAVY = 721;
    final int D_CRY_COUNT_LIGHT_MAGIC = 604;

    final int CLAN_OATH_HELM = 7850;

    final int CLAN_OATH_ARMOR = 7851;
    final int CLAN_OATH_GAUNTLETS = 7852;
    final int CLAN_OATH_SABATON = 7853;

    final int CLAN_OATH_BRIGANDINE = 7854;
    final int CLAN_OATH_LEATHER_GLOVES = 7855;
    final int CLAN_OATH_BOOTS = 7856;

    final int CLAN_OATH_AKETON = 7857;
    final int CLAN_OATH_PADDED_GLOVES = 7858;
    final int CLAN_OATH_SANDALS = 7859;
