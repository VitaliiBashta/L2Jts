...
public class SoDManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(SoDManager.class);
    ...
    public SoDManager() {
        LOGGER.info("Seed of Destruction Manager: Loaded");
    ...
    public static void teleportIntoSeed(final Player p) {
        p.teleToLocation(new Location(-245800, 220488, -12112));
    }

    public static void handleDoors(final boolean doOpen) {
    ...
    public static void openSeed(final long timelimit) {
        if (_isOpened) {
            return;
        }
        _isOpened = true;
        ...
        // spawns
        // handle zone + task
        LOGGER.info("Seed of Destruction Manager: Opening the seed for " + Util.formatTime((int) timelimit / 1000));
    ...
    public static void closeSeed() {
        ...
        _isOpened = false;
        LOGGER.info("Seed of Destruction Manager: Closing the seed.");
    ...
    private static class LazyHolder {
        private static final SoDManager INSTANCE = new SoDManager();
    }
}