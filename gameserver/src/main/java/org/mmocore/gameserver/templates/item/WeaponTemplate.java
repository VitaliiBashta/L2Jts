...
public final class WeaponTemplate extends ItemTemplate {
    ...
    public enum WeaponType implements ItemType {
        ...
        DUALFIST(10, "Dual Fist", Stats.DUALFIST_WPN_VULNERABILITY),
        BIGSWORD(11, "Big Sword", Stats.BIGSWORD_WPN_VULNERABILITY), // Two Handed Swords
        PET(12, "Pet", Stats.FIST_WPN_VULNERABILITY),
        ROD(13, "Rod", null),
        BIGBLUNT(14, "Big Blunt", Stats.BIGBLUNT_WPN_VULNERABILITY),
        CROSSBOW(15, "Crossbow", Stats.CROSSBOW_WPN_VULNERABILITY),
        RAPIER(16, "Rapier", Stats.RAPIER_WPN_VULNERABILITY),
        ANCIENTSWORD(17, "Ancient Sword", Stats.ANCIENT_WPN_VULNERABILITY), // Kamael 2h sword
        DUALDAGGER(18, "Dual Dagger", Stats.DUALDAGGER_WPN_VULNERABILITY);
