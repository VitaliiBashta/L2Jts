...
public class CharTemplate {
    ...
    private double basePAtkSpd;
    private double baseMAtkSpd;
    private double baseShldDef;
    private double baseShldRate;
    private double baseCritRate;
    private double baseMCritRate;
    private int baseRunSpd;
    private double baseWalkSpd;
    private double baseWaterRunSpd;
    private double baseWaterWalkSpd;
    private double baseHitModify;
    private double baseAvoidModify;
