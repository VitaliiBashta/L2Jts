...
public class AdminEnchant implements IAdminCommandHandler {
    ...
    private void setEnchant(final Player activeChar, final int ench, final int armorType) {
        ...
        if (!target.isPlayer()) {
            activeChar.sendAdminMessage("Wrong target type.");
            return;
        }
        ...
        final int curEnchant; // display purposes only
        ...
        if (itemInstance != null) {
            ...
            // informations
            activeChar.sendAdminMessage("Changed enchantment of " + player.getName() + "'s " + itemInstance.getName() + " from " + curEnchant + " to " + ench + '.');
    ...
    public void showMainPage(final Player activeChar) {
        ...
        replyMSG.append("<center>Enchant Equip for player: ").append(player.getName()).append("</center>");
