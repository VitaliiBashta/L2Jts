...
public final class ArmorSet {
    ...
    private final List<SkillEntry> _skills = new ArrayList<>(1);
    private final List<SkillEntry> _shieldSkills = new ArrayList<>(1);
    ...
    public boolean containAll(int chest, int legs, int head, int gloves, int feet) {
        return !(_chest.isEmpty() && !_chest.contains(chest)) &&
                !(!_legs.isEmpty() && !_legs.contains(legs)) &&
                !(!_head.isEmpty() && !_head.contains(head)) &&
                !(!_gloves.isEmpty() && !_gloves.contains(gloves)) &&
                !(!_feet.isEmpty() && !_feet.contains(feet));
    }
    ...
    public boolean isEnchanted6(Player player) {
        ...
        return !(!_chest.isEmpty() && chestItem.getEnchantLevel() < 6) &&
                !(!_legs.isEmpty() && legsItem.getEnchantLevel() < 6) &&
                !(!_gloves.isEmpty() && glovesItem.getEnchantLevel() < 6) &&
                !(!_head.isEmpty() && headItem.getEnchantLevel() < 6) &&
                !(!_feet.isEmpty() && feetItem.getEnchantLevel() < 6);
    }
}