...
public class ClanAirShipControllerInstance extends AirShipControllerInstance {
    ...
    public ClanAirShipControllerInstance(final int objectID, final NpcTemplate template) {
    ...
    public void onBypassFeedback(final Player player, final String command) {
        ...
        if ("summon".equalsIgnoreCase(command)) {
            ...
            final ClanAirShip clanAirship = player.getClan().getAirship();
            ...
            if (ItemFunctions.removeItem(player, ENERGY_STAR_STONE, 5) != 5) {
            ...
            ItemFunctions.removeItem(player, AIRSHIP_SUMMON_LICENSE, 1);
    ...
    protected ClanAirShip getDockedAirShip() {
        final ClanAirShip ship = _dockedShipRef.get();
    ...
    public void setDockedShip(final ClanAirShip dockedShip) {
