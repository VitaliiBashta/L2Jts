...
public class EffectHealPercent extends Effect {
    ...
    public EffectHealPercent(final Creature creature, final Creature target, final SkillEntry skill, final EffectTemplate template) {
    ...
    public void onStart() {
        ...
        final double hp = calc() * _effected.getMaxHp() / 100.;
